				...
				<div class="row justify-content-center pt-5">
					...
					<div class="col-md-6 col-lg-3 mb-5">
						<div class="portfolio-item workout-wrap mx-auto" data-toggle="modal"
							...
							<div>
								<img class="img-fluid"
									src="resources/images/workoutImage/bentKneePushCrunch.PNG"
									alt="..." />
							</div>
						</div>
						<div class="pt-3 text-dark text-center font-weight-bold">
					...
					<div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
						<div class="portfolio-item workout-wrap mx-auto" data-toggle="modal"
							...
							<div>
								<img class="img-fluid"
									src="resources/images/workoutImage/lyingHipExtension.PNG"
									alt="..." />
							</div>
						</div>
						<div class="pt-3 text-dark text-center font-weight-bold">
					...
					<div class="col-md-6 col-lg-3 mb-5 mb-md-0">
						<div class="portfolio-item workout-wrap mx-auto" data-toggle="modal"
							...
							<div>
								<img class="img-fluid"
									src="resources/images/workoutImage/hipBridge.PNG" alt="..." />
							</div>
						</div>
						<div class="pt-3 text-dark text-center font-weight-bold">
							<p>힙 브릿지</p>
