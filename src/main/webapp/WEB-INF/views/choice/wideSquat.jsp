					...
					<div class="row justify-content-center">
						...
						<div class="col-md-8 col-lg-8 mt-4">
							<div class="modal-body">
								<svg>
                        			<path id="ring" fill="#FF0000" />
  									<circle cx="100" cy="100" r="82" fill="#F6F6F6" />
  									<circle cx="100" cy="100" r="73" fill="none" stroke="#FF0000"
										stroke-width="7" opacity=".5" />
  									<text id="counter" x="100" y="100" text-anchor="middle"
										dominant-baseline="central" fill="#8C8C8C" font-size="60"
